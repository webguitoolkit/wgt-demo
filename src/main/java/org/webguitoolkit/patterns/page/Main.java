...
import org.webguitoolkit.patterns.sandbox.PopupView;
...
import org.webguitoolkit.patterns.views.jquery.AccordionJQView;
import org.webguitoolkit.patterns.views.jquery.DatepickerJQView;
import org.webguitoolkit.patterns.views.jquery.DialogJQView;
import org.webguitoolkit.patterns.views.jquery.TabJQView;
...
public class Main extends Page {
	...
	protected void initPatternHeader() {
		...
		addWgtJS("wgt.controller.tree.js");
//		addWgtJS( ResourceServlet.FULL_JS );
		// List control
		addWgtCSS("standard/wgtlist.css");
		addWgtCSS("standard/jquery-ui.css");
		addWgtJS("wgt.controller.jq.tabstrip.js");
		addWgtJS("wgt.controller.jq.datepicker.js");
		addWgtJS("wgt.controller.jq.control.js");
		
		addWgtCSS("jquery/flick/jquery-ui-1.8.18.custom.css");
...
//		factory.createMenuItem(menuPatterns, "Split Screen", null, new SplitScreenView(factory, viewConnector, 550));
		...
		factory.createMenuItem(gridFunctions, "JQ Tab", null, new TabJQView(factory, viewConnector));
		factory.createMenuItem(gridFunctions, "JQ Accordion", null, new AccordionJQView(factory, viewConnector));
		factory.createMenuItem(gridFunctions, "JQ DatePicker", null, new DatepickerJQView(factory, viewConnector));
		factory.createMenuItem(gridFunctions, "JQ Dialog", null, new DialogJQView(factory, viewConnector));
		factory.createMenuItem(gridFunctions, "Popup Button", null, new PopupView(factory, viewConnector));
